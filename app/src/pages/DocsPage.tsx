          ...
          {[
            {
              ...
              code: 'assert(tx[i].gas_price >= tx[i+1].gas_price && tx[i].arrival_ts <= tx[i+1].arrival_ts);',
            ...
            },
            {
              ...
              code: 'require(requestA.timestamp < requestB.timestamp && processB.timestamp < processA.timestamp);',
            ...
            },
            {
              ...
              code: 'require(vault.healthFactor() >= 1.25e18 && debtRepaid >= minRequired);',
